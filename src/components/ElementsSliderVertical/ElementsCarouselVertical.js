...
class ElementsSliderVertical extends Component {
    ...
    render() {
        ...
        return (
            <div>
            <div className="carousel_vertical card-body card col-12 sensorsList list-group list-group-flush">
                ...
                <div className="row ">
                    <button id="carousel-left" className="col-6" onClick={e => this.carouselRight()}>down</button>
                    <button id="carousel-left" className="col-6" onClick={e => this.carouselLeft()}>up</button>
